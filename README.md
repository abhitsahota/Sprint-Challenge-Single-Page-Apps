...
> Answer: Once the user has loaded the files from the server they will have a faster browsing experience on the site since there are no more server calls for site assets. 
